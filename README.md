...
| **[HTB-Audit-Archive](https://github.com/JoseMariaMicoli/Pentest-Audit-Portfolio)** | **Methodology Lab:** Curated repository of **HTB Penetration Testing Reports** and **NIST-compliant security audits**. | `Markdown` `Mermaid` |
